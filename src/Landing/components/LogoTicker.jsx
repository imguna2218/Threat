...
const features = [
  { icon: <ShieldBan />, label: "Security" },
  { icon: <MessageCircle/>, label: "AI Chating" },
  ...
  { icon: <RadioTower />, label: "Cyber Reports" },
];
  ...
  return (
    <div className="bg-black text-white py-16 sm:py-24 overflow-hidden">
      <div className="container mx-auto px-4">
        <h2 className="text-lg text-center text-white/70 mb-16">Features Provided by TrueSecure</h2>
