...
export const Hero = () => {
        ...
        <div className="flex justify-center mt-8">
          <div className="inline-flex relative">
            <h1 className='text-7xl sm:text-9xl font-bold tracking-tight text-center inline-flex'>
              True Secure <br /> is Here
            </h1>
            <motion.div className='absolute right-[600px] top-[108px] hidden sm:inline' drag dragSnapToOrigin>
              <img src={CursorImage} alt="cursor" height={200} width={200} className='max-w-none' draggable="false" />
            </motion.div>
            <motion.div className='absolute left-[690px] top-[56px] hidden sm:inline' drag dragSnapToOrigin>
  ...
  <p className='text-xl text-center mt-8 max-w-md'>
    Protect your digital presence with our cybersecurity solutions. Join us to ensure a secure environment for you and your organization!
  </p>
</div>
