...
const featurePoints = [
  { value: 95, label: "Bug Finder", position: 1 },
  { value: 150, label: "Efficiency", position: 2 },
  { value: 300, label: "Moderation", position: 4 },
  { value: 400, label: "Security", position: 6 },
];
          ...
          <CardWithEffect>
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="text-left p-6">
                <h1 className="text-white text-2xl font-bold mb-2">Multiple Features Offered by TrueSecure</h1>
